...
1. initialize: locate model output (function to make a config file?), read in basic run parameters and species names, run_truth for all once and save output (optionally, run_truth for only one species?)
