...
Things to add: checks for output timestep, loading bioind.file with function similar to load_catch, loading box file separately?
...
om_species <- function(species = spp, omlist, removefullom = TRUE){
  ...
  #-----REDO THIS with a function like load_catch and load above----#
  ...
  truecatchbio_ss <- omlist$truecatchbio[truecatchbio$species == species_ss,]

  #subset species YOY
  
  #subset species biol parameters
  
  #subset species funtional group info?
  ...
  if(removefullom = TRUE) rm(omlist)
