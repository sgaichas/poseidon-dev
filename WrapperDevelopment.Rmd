...
**Need to adjust time unit for fishery to years for this to work**
**Length comp may need this too**
...
#add this to om_indices function so that this has years when read in
fish_len_comp_data$time <- as.integer(fish_len_comp_data$time/365)
