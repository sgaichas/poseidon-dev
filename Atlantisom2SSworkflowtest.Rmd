...
In this example, we have a local folder "atlantisoutput" and the output of interest in a subdirectory:
  ...
  * "CalCurrentClimateTest1": California Current Atlantis model output from Isaac Kaplan's google drive \outputFolderAllOff2013Oceanography using the Hodgson et al. 2018 configuration.
