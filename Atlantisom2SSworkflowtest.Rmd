...
It doesnt. A hack gets it closer, suggesting that the problem is a bug in the output for models using codebases prior to late 2015 (CCA is mid-2015).
...
Test this with NOBA model, which may be in the codebase that doesn't have this problem with the CATCH.nc file. 
