---
title: "Testing atlantisom: generate census length comps for California Current Atlantis"
...
```{r allspplength, eval=FALSE, echo=TRUE}
...
ss_length_censussurvsamp <- length_censussurvsamp[length_censussurvsamp$species == "Herring",]
