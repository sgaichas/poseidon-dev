---
title: "Testing atlantisom: generate survey sampled length comps for Northeast US  Atlantis"
...
```{r allspplengthsamp, echo=TRUE, eval=FALSE}
...
Runtime for census lengths was <1 hour for NEUS because it is a 50 year run and we are taking lengths only once per year. For standard survey lengths runtime was not reduced because the dimensions (species, timesteps) were identical.

Compare sampled lf with census from [here](https://sgaichas.github.io/poseidon-dev/NEUSTrueLengthCompTest.html): 
