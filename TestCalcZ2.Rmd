...
Time to step through line by line again. Revised as below. Better (apportions annual recruitment to timesteps), but not sure this is fully correct?
...
Two approaches: sum nums each year, calculate survival between years (minus annual recruitment), turn into annual Z, or multiply timestep Zs to get annual?
