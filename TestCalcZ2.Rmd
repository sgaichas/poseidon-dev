...
# everything below the function definition line
  ...
  for (irow in 1:nrow(recstart_temp)) {
    ...
    # this part still returns a constant fraction
    # and does not alter Time to change from annual to actual recruitment time
    # still not understanding what this is meant to do
...
# Time in YOY does not match recstart-recend period still after this loop
