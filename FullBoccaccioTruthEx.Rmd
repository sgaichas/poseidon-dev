...
# run survey  and sample fish on this for completeness?


# plot it--first few timesteps for bocaccio

trueNatage_ss <- trueagesall[trueagesall$species == "Bocaccio_rockfish",]

Natageplot <- ggplot(trueNatage_ss, aes(x=agecl, y=atoutput)) +
  geom_point() +
  theme_tufte() +
  labs(subtitle = paste(scenario.name,
