...
Is there a mismatch between biomass based F and numbers based Z?
...
Or maybe spring spawning herring leave the model area and I'm not accounting for that (is this a run with broken migration?).
...
# align nums previous timestep with catch current timestep
