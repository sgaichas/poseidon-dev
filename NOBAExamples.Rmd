---
title: "Testing atlantisom: true biomass output from Norwegian-Barents Atlantis"
...
```{r matchBp4, fig.cap="Testing whether the survey census gives the same results as the Atlantis output biomass index file; last 9 species."}
compareB + 
...
```{r wtagecalc, fig.cap="Check weight at age generated from biomass_age\\$atoutput divided by nums\\$atoutput for up to 48 groups.", fig.show="hold"}
...
```{r matchBfromN4, fig.cap="Testing whether the survey census based on numbers converted to biomass gives the same results as the Atlantis output biomass index file; last 9 species. "}
