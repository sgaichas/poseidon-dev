...
#### Survey weight at age (annual ages) pending new function
```{r plot-annwtage}
...
Running `om_init()`, `om_species()`, `om_index()`, `om_comps()` in chunk above to make sure the original output is preserved, then plot the annage output [above](#annageoutput). 
