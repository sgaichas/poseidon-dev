...
1. For clarity, `calc_age2length` should be renamed `calc_stage2length`
2. Between `sample_fish` and `sample_ages` we need the already written `calc_stage2age` function, which calls `calc_Z`. Test these next.
