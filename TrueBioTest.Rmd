...
```{r census-spec, message=FALSE, warning=FALSE, eval=FALSE}
...
if(initCCA) boxall <- c(0:29) #placeholder, correct for CCA
if(initNEUS) boxall <- c(0:29)
if(initNOBA) boxall <- c(0:29) #placeholder, correct for NOBA

# should return all model output timesteps; need to generalize
if(initCCA) timeall <- c(0:251) #placeholder, correct for CCA
if(initNEUS) timeall <- c(0:251)
if(initNOBA) timeall <- c(0:251) #placeholder, correct for NOBA
...
if(initCCA) survspp <- funct.group.names[1:21] #placeholder, correct for CCA
if(initNEUS) survspp <- funct.group.names[1:21]
if(initNOBA) survspp <- funct.group.names[1:21] #placeholder, correct for NOBA
