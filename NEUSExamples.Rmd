---
title: "Testing atlantisom: true biomass output from Northeast US Atlantis"
...
```{r matchBp3, fig.cap="Testing whether the survey census gives the same results as the Atlantis output biomass index file; last 9 species."}
compareB + 
...
```{r matchBfromN3, fig.cap="Testing whether the survey census based on numbers converted to biomass gives the same results as the Atlantis output biomass index file; last 9 species."}
