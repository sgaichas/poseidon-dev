...
diet <- data.table::fread(file.path(here("atlantisoutput",
                                                  "NOBA_march_2020"), 
                                                "NOBADetDiet.gz"))
...
# function not working so test piecewise again
# detaileddiettest <- load_detailed_diet_comp(here("atlantisoutput",
#                                                  "NOBA_march_2020"), 
#                            "NOBADetDiet.gz", 
#                            fgs = fgs)
...
# detaileddiettest <- load_detailed_diet_comp(here("atlantisoutput",
#                                                  "NOBA_march_2020"), 
#                            "nordic_runresults_01DetailedDietCheck.txt.gz", 
#                            fgs = fgs)

# detailedpartdt <- data.table::fread(file.path(here("atlantisoutput",
#                                                  "NOBA_march_2020"), 
#                            "nordic_runresults_01DetailedDietCheck.txt.gz"),
#                            nrows = 20000
#                            )
...
Still having problems with the function after editing

```{r detdiettest, eval=FALSE}
  
# still not working but works line by line
