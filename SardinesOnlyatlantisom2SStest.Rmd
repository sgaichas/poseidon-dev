...
#Sample fish for age composition from survey
age_comp_data <- sample_fish(survey_out, highEffN)
...
Can we match catch in weight from catch.txt? No, see above.
...
#Test writing CPUE in biomass
  stocksynthesis.data <- SS_write_ts(ss_data_list = stocksynthesis.data,
                ts_data = list(survObsBiomB$atoutput[fish_years],
