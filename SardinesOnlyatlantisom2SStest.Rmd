...
plotB <-ggplot() +
  geom_line(data=trueB_ss, aes(x=time/stepperyr,y=atoutput, color="survey census N"), 
            alpha = 10/10) +
  theme_tufte() +
...
Specify our survey sampling. This could come from other information such as the overlap of actual survey stations with OM polygons, experiments evaluating survey selectivity and efficiency, actual sample-based survey cv, etc. Here we guess using Christine's specifications:

```{r sardine-survey-spec}
# from atlantisom/config/sardine_config.R, to be generalized here

#Set species name
species <- "Pacific_sardine" #change to species_ss to match 
