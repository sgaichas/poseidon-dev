...
Now we test the `atlantisom` to SS workflow with a new California Current run that includes climate forcing, recruitment variability, and the fishing scenario outlined for our project in Norway: "output_CC_2063_OA_OFF_222". 
...
```{r true-comps, warning=FALSE, message=FALSE}
...
# both these errors come from the fishery age and length comps when I step
# through the function, survey caal and lengths read in fine
